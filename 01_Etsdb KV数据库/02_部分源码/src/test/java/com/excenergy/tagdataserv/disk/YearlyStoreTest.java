...
import com.excenergy.tagdataserv.disk.YearlyStore;
 ...
 * Author: Li Pengpeng
 */
public class YearlyStoreTest {

    private YearlyStore store;
    private long online;

    @Before
    public void before() throws Exception {
        online = new DateTime(2010,10,10,10,10,0).getMillis();
        store = new YearlyStore(online);
    }
    ...
    public void testPath() throws Exception {
        ...
        assertTrue(path.toString().equals("tmp\\2013"));
    ...
    public void testNext() throws Exception {
        DateTime dateTime = new DateTime(2012, 2, 28, 16, 5, 18, 500);
        Path path = store.path(Paths.get("tmp"), dateTime.getMillis());
        assertTrue(path.toString().equals("tmp\\2012"));
