...
public class RepairInfo {
    ...
    @Deprecated()
    public RepairInfo(Set<String> metrics, LocalDateTime beginTime, LocalDateTime endTime) {
    ...
    private RepairInfo(Map<String, Set<LocalDateTime>> map) {
        this.map = map;
    ...
    public static RepairInfo fromDataPoint(DataPoint dp) {
        RepairInfo info = RepairInfo.decoder(dp.getVal());
        info.time = dp.getDateTime();
        return info;
    }

    public static String encoder(RepairInfo info) {
        Map<String, Set<LocalDateTime>> map = info.getMap();
        return JSON.toJSONString(map);
    }

    public static RepairInfo decoder(String json) {
        Map<String, Set<LocalDateTime>> map = JSON.parseObject(json, new TypeReference<Map<String, Set<LocalDateTime>>>() {
        });
        return new RepairInfo(map);
    }
    ...
    public synchronized RepairInfo reset() {
